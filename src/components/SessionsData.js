          ...
          <div className="d-flex h-100 position-relative b-skills">
            <div className="w-100">
              ...
              <div className="list-group mt-3">
                {question.data.posibilities.map((posibility, ind) => (
                  <div key={ind} className="list-group-item bg-secondary">
                    {posibility}
                  </div>
                ))}
              </div>
